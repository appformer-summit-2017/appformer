 ...
 */
@Dependent
public class DateBoxFieldProvider implements FieldProvider<DateBoxFieldDefinition> {
    @Override
    ...
    @Override
    public DateBoxFieldDefinition newInstance() {
        return new DateBoxFieldDefinition();
    }
}
