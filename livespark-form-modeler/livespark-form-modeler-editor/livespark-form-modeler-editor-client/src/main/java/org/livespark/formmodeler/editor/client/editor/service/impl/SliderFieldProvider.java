 ...
 */
@Dependent
public class SliderFieldProvider implements FieldProvider<SliderFieldDefinition> {
    @Override
    ...
    @Override
    public SliderFieldDefinition newInstance() {
        return new SliderFieldDefinition();
    }
}
