 ...
 */
@Dependent
public class ListBoxFieldProvider implements FieldProvider<ListBoxFieldDefinition> {
    @Override
    ...
    @Override
    public ListBoxFieldDefinition newInstance() {
        return new ListBoxFieldDefinition();
    }
}
