...
public class LiveSparkAppScreenViewImpl extends Composite implements LiveSparkAppScreen.LiveSparkAppScreenView {
    ...
    @DataField
    protected Panel homePageContent = new FlowPanel();

    @DataField
    protected Panel dashboardsContent = new FlowPanel();
    ...
    @Override
    public void init( final LiveSparkApp liveSparkApp ) {
        homePageContent.clear();
        dashboardsContent.clear();
