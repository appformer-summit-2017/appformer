...
package org.livespark.deployment.client.perspectives.administration.editor;
...
import org.livespark.deployment.client.perspectives.administration.editor.layout.LiveSparkAppLayoutEditor;
import org.livespark.deployment.client.perspectives.administration.editor.main.MainPageView;
...
public class AppEditorScreenPresenter extends BaseLiveSparkAppScreen {
    ...
    public String getTitle() {
        if ( liveSparkApp != null ) {
            return translationService.format( DeploymentConstants.editing, liveSparkApp.toString() );
        }
        return translationService.getTranslation( DeploymentConstants.editingApp );
    }
