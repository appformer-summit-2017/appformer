...
import org.livespark.backend.dashbuilder.layout.LayoutGenerator;
import org.livespark.backend.server.service.build.LiveSparkAppBuilderImpl;
    ...
    protected void geneareteDataSets( final LiveSparkApp app, final Project project ) {
        ...
        try {
            ...
            while ( rs.next() ) {
                ...
                app.getDataSets().add( dataSetDef.getUUID() );
